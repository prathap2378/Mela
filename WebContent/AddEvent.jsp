...
<tr>
<td width="100%">
<label class="Event" id="event">Event : </label>
...
<tr>
<td width="50%">
<label class="EventLocation" id="eventLocation">Location:</label>
<input class="eventLocation" id="eventLocation" name="eventLocation" value="" type="text" maxlength="150">
<div>
<label class="EventCity" id="eventCityl">City : </label>
<input class="eventLocation" id="eventCity" name="eventCity" value="" type="text" maxlength="150"></div>
<div>
<label class="EventState" id="eventStatel">State : </label>
<input class="eventLocation" id="eventState" name="eventState" value="" type="text" maxlength="150"></div>
</td>
<td width="50%">
<table>
<tr>
<td>
<label class="EventAddressl" id="eventAdressl">Address : </label></td>
...
<td align="left">
<div class="">
<label class="StartDate" id="stDate">Start Date:</label>
<input id="sDate" name="sDate" value="" type="date" width="100%"></div>
</td>
<td>
<div class="" align="left">
<label class="EndDate" id="edDate">End Date:</label>
...
<td>
<div>
<label class="StartTime" id="stTime">Satrt Time:</label>
...
<td>
<div>
<label class="EndTime" id="edTime">End Time:</label>
